...
const TopRestaurants = () => {
  ...
  return (
    <div className="mt-6 mx-40">
        ...
        {foods.map((food, index) => (
          <div key={index} className="px-2">
            <img
              ...
              className=" h-28 w-80 object-cover rounded-lg shadow-lg my-2" // Adjusted classes for image styling
            />
      ...
      {/* Slide Progress Bar */}
      <div className="mt-2 h-1 w-4 bg-gray-300 rounded ">
        <div
          style={{ width: `${progressWidth}%` }}
          className="h-1 bg-green-500 rounded flex"
        ></div>
      </div>
    </div>
  );
