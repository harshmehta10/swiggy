                ...
                <div className="flex items-center">
                  <span className="px-2">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M6.18 4.92C6.18 3.91 6.99 3.09 8.01 3.09H12c1.01 0 1.83.82 1.83 1.83v.31c0 .39-.31.7-.7.7H6.88c-.39 0-.7-.31-.7-.7v-.31z"
                        fill="#02060C"
                        fillOpacity="0.75"
                      />
                    </svg>
                ...
                <div className="flex items-center">
                  <span className="px-2">
                    <svg
                      ...
                      aria-label="Search"
                    >
                      <path d="M17.67 17.14l5.06 5.06-1.8 1.8-5.22-5.22a10.2 10.2 0 01-7.47 2.61C4.57 20.39 0 15.83 0 10.2S4.57 0 10.2 0s10.2 4.57 10.2 10.2a10.2 10.2 0 01-2.53 6.94zm-7.47.7a7.65 7.65 0 100-15.3 7.65 7.65 0 000 15.3z" />
                    </svg>
                  </span>
                  <span>Search</span>
                </div>
